      ...
      <section ref={heroRef} className="relative overflow-hidden min-h-[35vh] lg:min-h-[40vh] flex items-start pt-28 pb-12 mb-16">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt="US immigration FAQ background"
            fill
            sizes="100vw"
      ...
      <div className="max-w-360 mx-auto px-6 lg:px-12">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
          ...
          <div className="w-full lg:w-[30%] shrink-0 lg:sticky lg:top-32">
            <h2 className="text-xl font-bold text-brand-dark mb-6 pl-2">Categories</h2>
          ...
          <div className="w-full lg:w-[70%]">
            <div className="mb-10">
              <h3 className="text-3xl font-bold text-brand-dark mb-3">{activeCategory.title}</h3>
