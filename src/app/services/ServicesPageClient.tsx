...
import { Settings, Megaphone, TrendingUp, Briefcase, Globe, FileCheck, ArrowLeft } from "lucide-react";
      ...
      <section className="relative overflow-hidden min-h-[35vh] lg:min-h-[40vh] flex items-start pt-28 pb-12">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt="US immigration services office background"
            fill
            sizes="100vw"
        ...
        <div className="max-w-360 w-full mx-auto px-6 lg:px-12 relative z-10 text-left">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-[46px] font-bold text-white leading-[1.1] mb-4">
            US Immigration <span className="text-brand-primary">Services</span>
          </h1>
          <p className="text-base lg:text-lg text-gray-300 max-w-2xl">
            We offer specialized guidance across a wide range of U.S. visa and Green Card pathways — EB-1A, EB-2 NIW, EB-5, E-2, and more — to help you achieve your American dream.
          </p>
        </div>
      </section>
