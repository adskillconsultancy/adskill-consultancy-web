...
export default function WhatsAppButton() {
  ...
  useEffect(() => {
    // Show the button after a slight delay to ensure it doesn't block initial rendering
  ...
  return (
    <Link
      href="https://api.whatsapp.com/send/?phone=16467728544&text&type=phone_number&app_absent=0"
      target="_blank"
