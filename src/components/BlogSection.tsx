...
export default function BlogSection() {
  ...
  const maxIndex = Math.max(0, recentBlogs.length - slidesPerView);
  ...
  return (
    <section
      className="py-20 lg:py-28 bg-[#f8f9fa] relative"
      ...
      <div className="max-w-360 mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="relative px-2 lg:px-8">
          <div className="overflow-hidden -my-16 py-16 -mx-4 px-4">
            <div
              className="flex transition-transform duration-500 ease-in-out"
              style={{
                transform: `translateX(-${current * pct}%)`,
              }}>
