        ...
        <div className="flex flex-col lg:flex-row justify-between items-end mb-10 px-6 lg:px-12">
          <div className="max-w-xl">
            <div className="inline-block px-4 py-1.5 rounded-full bg-brand-primary mb-4">
              <span className="text-xs font-bold text-brand-dark uppercase tracking-wider">SERVICE AREA</span>
            </div>
          ...
          <div className="mt-8 lg:mt-0 relative hidden md:block">
            ...
            <Link href="/services" className="inline-flex items-center justify-center px-10 h-14 bg-brand-primary text-brand-dark font-bold hover:bg-white transition-colors">
              All Services
            </Link>
          </div>
        </div>
            ...
            >
              <div className="w-1/2 bg-brand-dark p-8 flex flex-col justify-between relative group-hover:bg-opacity-95 transition-colors overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed line-clamp-3">{service.overview}</p>
                </div>
              </div>
